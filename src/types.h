...
#define TYPES_H
#include <string>
const static uint8_t TRAP_START = 0;
const static uint8_t TRAP_BRANCH = 1;
const static uint8_t TRAP_RETURN = 2;
...
struct trap_info_t
{
    ...
    uint64_t trap_type;     // Type of trap (TRAP_START, TRAP_BRANCH, TRAP_RETURN)
};
